...
import "../css/PSMCertificateUpload.css";
import { DialogContent } from "@mui/material";
import "../../node_modules/bootstrap/dist/css/bootstrap.min.css";

const PSMCertificateUpload = (props) => {
  ...
  return (
    <>
      <Dialog
        className="psm-certificate-content"
        open={props.open}
        keepMounted
      ...
      >
        ...
        >
          <div
            className="psm-header"
            style={{ padding: "24px 15px 17px 40px" }}
          >
            <p
              style={{
          ...
          <ol style={{ paddingLeft: "3rem" }}>
            {selectedFiles.map((file) => (
              <>
                <li className="psm-item" style={{ listStyleType: "none" }}>
                  <svg
...
export default PSMCertificateUpload;
